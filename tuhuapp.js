...
const jsname = '途虎App签到'
const logDebug = 0

const notifyFlag = 1; //0为关闭通知，1为打开通知,默认为1
const notify = $.isNode() ? require('./sendNotify') : '';
let notifyStr = ''
let userHost = 'api.tuhu.cn'
let httpResult //global buffer

let userCookie = ($.isNode() ? process.env.TuhuApp : $.getdata('TuhuApp')) || '';
let userUA = 'Dalvik/2.1.0 (Linux; U; Android 7.1.2; MI 6X Build/N6F26Q) tuhuAndroid 6.28.5';
...
async function doSign(auth) {
    try {
        ...
        if (result.Code == "1"){
            ...
            let msg = `途虎App签到失败，错误数据：${JSON.stringify(result)}\n`
            notifyStr += msg
            console.log(msg)
        }
    } catch (e) {
...
function populateUrlObject(url, authorization,body=''){
    let urlObject = {
        ...
        headers: {
            ...
            'fingerprint':'',
